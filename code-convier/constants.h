...
const char TOP_LEFT_CORNER_IMAGE[] = "./sprites/TL wall.png";
const char TOP_RIGHT_CORNER_IMAGE[] = "./sprites/TR wall.png";
const char BOTTOM_LEFT_CORNER_IMAGE[] = "./sprites/BL wall.png";
const char BOTTOM_RIGHT_CORNER_IMAGE[] = "./sprites/BR wall.png";
...
const float ENEMY_ATTACK_RANGE = 500.0f;
const float ENEMY_MIN_RANGE = 100.0f;
const float ENEMY_CHASE_RANGE = 1000.0f;
